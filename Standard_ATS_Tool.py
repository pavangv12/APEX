...
st.set_page_config(page_title="Smart ATS Resume Matcher", layout="centered")
st.title("Smart ATS Resume Matcher")
st.caption("Evaluate your resume against a job description using Generative AI.")
...
if submit:
    ...
    if response_text:
        try:
            ...
            c.drawString(50, height - 50, "Smart ATS Resume Report")
